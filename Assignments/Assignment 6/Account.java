...
public class Account {
	...
	public String getAcctType() {
		return this.getClass().getName(); // returns the string of the class
											// name
	}
	...
	/*
	 * Output of the unit test Account name: John Smith, Account Type: Account,
	 * Balance: $100.00 Account name: John Smith, Account Type: Account,
	 * Balance: $69.75 Account name: John Smith, Account Type: Account, Balance:
	 * $79.85
	 */
